...
app = Quart(__name__)
app.config["SECRET_KEY"] = "mx7Qy!8+>.cunMDW'Sw@5z"
...
ipc_client = ipc.Client(secret_key="mx7Qy!8+>.cunMDW'Sw@5z")
...
@app.route("/test")
async def test():
    test = await ipc_client.request("get_bot_guilds")
    return f"{test} pls work"
