    ...
    try:
        async with app.app_context():
            ...
            if leave_channel  is not None:
                await ipc_client.request("save_welcome", guild_id=guild_id, leave_channel=leave_channel, leave_role=leave_role,welcome_message=welcome_message, toggle_status=toggle_status)
