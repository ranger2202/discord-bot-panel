...
function saveChannel() {
    var selectedChannel = document.getElementById("channelDropdown1").selectedOptions;
    ...
    var channelId = selectedChannel[0].value; // Access the value of the first selected option
