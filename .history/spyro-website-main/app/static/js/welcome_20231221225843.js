...
function saveChannel() {
    ...
    var selectedChannel = document.getElementById("welcom-dropdown").selectedOptions;
    ...
    var rolelId = selectedChannel[0].value; // Access the value of the first selected option
